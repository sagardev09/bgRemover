                    ...
                    {!image && <div className="input">
                        <label className="file-label inline-block cursor-pointer relative overflow-hidden font-medium text-sm">
                            <input
                                ...
                                className="file-input absolute font-medium opacity-0 cursor-pointer"
                                id="fileInput"
                            />
                        </label>
                        <motion.button
...
active:border-b-[2px] active:brightness-90 active:translate-y-[2px] mt-6"
                    ...
                    {remove && <div className='flex items-center justify-center w-full'>
                        {!isLoading ? <motion.button whileTap={{
                            scale: 0.9
                        }}
                            disabled={!image}
